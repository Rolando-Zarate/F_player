...
w = Scale(root, from_=0, to=100, orient=HORIZONTAL,variable=var,command=sel,bd=0,relief="solid")
w.place(x=550,y=25)
w.set(100)
botonPlayPause= Button(root,bd=1,relief="solid",text="4",font=("Webdings",20),compound="top",command=PlayPause)#4=play,;=pause
botonPlayPause.place(x=200,y=30)

botonStop= Button(root,bd=1,relief="solid",text="g",font=("Webdings",15),compound="top",command=Stop)
botonStop.place(x=268,y=30)

botonPrevious= Button(root,bd=1,relief="solid",text="9",font=("Webdings",12),compound="top",command=Previous,pady=1,padx=6)
botonPrevious.place(x=100,y=30)

botonNext= Button(root,bd=1,relief="solid",text=":",font=("Webdings",12),compound="top",command=Next,pady=1,padx=6)
botonNext.place(x=318,y=30)

botonRepeat= Button(root,bd=1,relief="solid",text="q",font=("Webdings",15),compound="top",command=Repeat)
botonRepeat.place(x=150,y=30)

playing=Label(root,text="No file",font=("Calibri",15,))
playing.place(x=100,y=0)

VolumeTitle=Label(root,text="Volume",font=("Calibri",12,))
VolumeTitle.place(x=550,y=65)
